...
{
    m_btnStart->setText(QString::fromLocal8Bit("开始"));
    m_btnPause->setText(QString::fromLocal8Bit("暂停"));
    m_btnStop->setText(QString::fromLocal8Bit("结束"));
    setWindowTitle(QString::fromLocal8Bit("贪吃蛇"));
    ...
    m_labScoreStr->setText(QString::fromLocal8Bit("当前分数"));
